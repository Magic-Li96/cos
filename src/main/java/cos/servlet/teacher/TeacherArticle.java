...
/**
 * Servlet implementation class TeacherArticle
 */
@WebServlet("/teacherArticle")
public class TeacherArticle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			response.sendRedirect("/cos/system/teacher/article.jsp");
		} catch (Exception e) {
