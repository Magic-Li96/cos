...
/**
 * Servlet implementation class DeleteTeacherArticle
 */
@WebServlet("/deleteTeacherArticle")
public class DeleteTeacherArticle extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			sqlSession.commit();
			sqlSession.close();
			response.sendRedirect("/cos/teacherArticle");
		} catch (Exception e) {
