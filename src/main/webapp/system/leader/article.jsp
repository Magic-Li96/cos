					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-left">
							...
							<li class="active"><a href="#"> <span
									class="glyphicon glyphicon-user"><%=institute.getInstituteName()%></span>
							</a></li>
						</ul>
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
					          ...
					          <ul class="dropdown-menu">
					            <li><a class="btn btn-default" href="/cos/insAllArticleForLeader">学院中所有课程大纲</a></li>
					            <li><a class="btn btn-default" href="/cos/waitFinallAccessArticle">显示待终审课程大纲</a></li>
								...
								%>
									...
									<script type="text/javascript">
										function passSuccess() {
											...
											if (r == true) {
												location.href='/cos/finalPassSuccess?src=<%=src%>';
											} else {
												return;
											}
										}
					...
					<tfoot>
						<tr class="text-center">
							<td colspan="5">
								<nav>
								  <ul class="pagination">
								    <li><a href="/cos/insAllArticleForLeader?current_page=<%=current_page%>&page_index=prior&subId=<%=request.getParameter("title")%>">&laquo;</a></li>
								    <% 
								    	for(int i=0;i < page_quantity;i++){
								    %>
								    <li><a href="/cos/insAllArticleForLeader?current_page=<%=current_page%>&page_index=<%=i%>&subId=<%=request.getParameter("title")%>"><%=i+1%></a></li>
								    <%
								    	}
								    %>
								    <li><a href="/cos/insAllArticleForLeader?current_page=<%=current_page%>&page_index=next&subId=<%=request.getParameter("title")%>">&raquo;</a></li>
								  </ul>
								</nav>
							</td>
						</tr>
