...
<body style="background-color: rgb(150, 141, 236);">
	<div class="container">
		...
		<!-- 按ID查询用户模态框 -->
		<div id="searchByIdModal" class="modal fade" tabindex="-1"
			role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 style="font-weight: 600;" class="modal-title text-center">请输入用户ID</h4>
					</div>
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td><input id="sId" type="text"
										class="form-control text-center" placeholder="请输入职工ID"></td>
								</tr>
							</tbody>
						</table>
					</div>
					...
					<div class="modal-footer">
						...
						<button onclick="searchById()" type="button"
		...
		<!-- 按学院查询用户模态框 -->
		<div id="searchByInstituteModal" class="modal fade" tabindex="-1"
			role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
						...
						<table class="table">
							<tbody>
								<tr>
									...
									<td class="text-center"><select id="sinsID"
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">返回</button>
						<button onclick="searchByInstitute()" type="button" class="btn btn-primary">查找</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
...
<script>
	...
	function searchById(){
		var sid = window.document.getElementById("sId").value;
		if(sid===""){
			window.alert("请输入ID");
			return;
		}
	...
	function searchByInstitute(){
		var sinsID = window.document.getElementById("sinsID").value;
		window.location.href='/cos/searchUserByInstitute?instituteId='+sinsID;
	}
